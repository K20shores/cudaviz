from _cudaviz import _matmul, _tiled_matmul, _tensor_matmul
...
def tensor_matmul(N: int = 1024):
  """ 
  Multiply two NxN matrices together and report the time it takes using cuda tensor cores
